#!/usr/bin/env python3
"""
Whisper Audio Translate - Importable Audio Translation Module
Uses OpenAI Whisper model for Hindi/English audio to English text translation

Usage:
    from whisper_audio_translate import WhisperTranslator, translate_audio_to_english
...
def main():
    ...
    print("=" * 70)
    print("🚀 WHISPER AUDIO TRANSLATE - HINDI/ENGLISH TO ENGLISH")
    print("=" * 70)
    ...
    print("   from whisper_audio_translate import WhisperTranslator, translate_audio_to_english")
    print("   from whisper_audio_translate import translate_audio_batch, print_translation_results")
    print("   ")
    print("   # Simple usage")
